package com.sp.sharan.mytrackmap;
...
import com.sp.sharan.mytrackmap.Utils.Helper;
import com.sp.sharan.mytrackmap.model.DirectionObject;
import com.sp.sharan.mytrackmap.model.LegsObject;
import com.sp.sharan.mytrackmap.model.PolylineObject;
import com.sp.sharan.mytrackmap.model.RouteObject;
import com.sp.sharan.mytrackmap.model.StepsObject;
import com.sp.sharan.mytrackmap.Utils.VolleySingleton;
import com.sp.sharan.mytrackmap.network.GsonRequest;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mGoogleApiClient == null) {
            mGoogleApiClient = /*new GoogleApiClient.Builder(this)
                    ...
                    .build();*/
            new GoogleApiClient.Builder(this).addConnectionCallbacks(this).addApi(LocationServices.API).build();
        }
    ...
    private void drawRouteOnMap(GoogleMap map, List<LatLng> positions){
        PolylineOptions options = new PolylineOptions().width(9).color(Color.DKGRAY).geodesic(true);
